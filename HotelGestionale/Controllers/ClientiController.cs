...
namespace HotelGestionale.Controllers
{
    ...
    public class ClientiController : Controller
    {
        ...
        public ClientiController(HotelGestionaleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cognome,CodiceFiscale,Citta,Provinvia,Email,Telefono,Cellulare")] Clienti clienti)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cognome,CodiceFiscale,Citta,Provinvia,Email,Telefono,Cellulare")] Clienti clienti)
        {
            if (id != clienti.Id)
            {
                return NotFound();
